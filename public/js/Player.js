var Player = Class.extend({
	...
	init: function(data, sprite) {
		...
		var style = { font: "12px Impact", fill: "#ff0044", /*wordWrap: true, wordWrapWidth: sprite.width,*/ align: "center" };

		var style2 = { font: "12px Impact", fill: "#74c61a", wordWrap: true, wordWrapWidth: sprite.width * 5, align: "center" };
		...
		this.draw = function() {
			...
			nameText.y = Math.floor(this.sprite.body.y - 10);
			...
			if(this.healthBar != null) {
				...
				this.healthBar.setPosition(this.sprite.body.x + (this.sprite.body.width / 2), this.sprite.body.y + this.sprite.body.height + 6);
